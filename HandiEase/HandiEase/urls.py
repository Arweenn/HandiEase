...
urlpatterns = [
    ...
    path('add_to_reading_list/<int:article_id>/', readingList.add_to_reading_list, name="add_to_reading_list"),
    path('remove_from_reading_list/<int:article_id>/', readingList.remove_from_reading_list, name="remove_from_reading_list"),
]
